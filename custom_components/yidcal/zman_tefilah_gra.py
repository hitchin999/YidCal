...
_LABEL = "סוף זמן תפילה גר״א"


class SofZmanTefilahGRASensor(YidCalZmanDevice, SensorEntity):
    """Sof Zman Tefilah (GRA) — coordinator-migrated.

    Single source of truth: reads 'סוף זמן תפילה גר״א' from ZmanimCoordinator's
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        super().__init__()
        self.entity_id = "sensor.yidcal_sof_zman_tefilah_gra"
        self.hass = hass
