...
_WATERMARK_X = 12.0   # in from the edge enough to survive print
                      # margins/cropping, but shy of the card
                      # border (~24 pt) in this tight gutter
    ...
    def _table(self, w: WeeklyData) -> None:
        ...
        for ri, day in enumerate(w.days):
            ...
            for i, (disp, canon) in enumerate(cols):
                ...
                _tf = getattr(w, "time_format", "12") or "12"
