...
_LABEL = "פלג המנחה מג״א"


class PlagHaMinchaMGASensor(YidCalZmanDevice, SensorEntity):
    """Plag HaMincha (MGA) — coordinator-migrated.

    Single source of truth: reads 'פלג המנחה מג״א' from ZmanimCoordinator's
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        super().__init__()
        self.entity_id = "sensor.yidcal_plag_hamincha"
        self.hass = hass
