...
class MinchaKetanaSensor(YidCalZmanDevice, SensorEntity):
    """Mincha Ketana — coordinator-migrated.

    Single source of truth: reads 'מנחה קטנה' from ZmanimCoordinator's
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        super().__init__()
        self.entity_id = "sensor.yidcal_mincha_ketana"
        self.hass = hass
