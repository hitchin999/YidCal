...
class MinchaGedolaSensor(YidCalZmanDevice, SensorEntity):
    """Mincha Gedola — coordinator-migrated.

    Single source of truth: reads 'מנחה גדולה' from ZmanimCoordinator's
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        super().__init__()
        self.entity_id = "sensor.yidcal_mincha_gedola"
        self.hass = hass
    ...
    def _recompute_from_coordinator(self) -> None:
        ...
        self._attr_extra_state_attributes = {
            "Mincha_Gedola_With_Seconds": full_iso_today,
            "Mincha_Gedola_Simple": human_today,
