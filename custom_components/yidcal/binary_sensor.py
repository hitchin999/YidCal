...
SLUG_OVERRIDES: dict[str, str] = {
    ...
    "מוצאי סוכות ימים ראשונים": "motzei_sukkos_first_days",
    ...
    "פורים":                "purim",
    "פורים קטן":            "purim_katan",
    "שושן פורים":           "shushan_purim",
    "שושן פורים קטן":       "shushan_purim_katan",
    ...
    "מוצאי פסח ימים ראשונים":  "motzei_pesach_first_days",
