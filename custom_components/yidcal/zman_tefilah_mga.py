...
_LABEL = "סוף זמן תפילה מג״א"


class SofZmanTefilahMGASensor(YidCalZmanDevice, SensorEntity):
    """Sof Zman Tefilah (MGA) — coordinator-migrated.

    Single source of truth: reads 'סוף זמן תפילה מג״א' from ZmanimCoordinator's
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        super().__init__()
        self.entity_id = "sensor.yidcal_sof_zman_tefilah_mga"
        self.hass = hass
